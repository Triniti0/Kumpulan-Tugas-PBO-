    ...
    public static void mainApp() {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            try { 
                ...
                r.insertData();  // Create (Insert) operation
                ...
                // Update operation
                r.setHargaBarang(150.0);  
                r.setJumlahBeli(3);
                r.updateData(recordId);
                
                // Delete operation
                r.deleteData(recordId);
                
                //data masih belum di entry sehingga output nanti akan menghasilkan databse yang kosong. 
                //Method update dan delete masih bisa berjalan.
                r.tampilStruk1();
